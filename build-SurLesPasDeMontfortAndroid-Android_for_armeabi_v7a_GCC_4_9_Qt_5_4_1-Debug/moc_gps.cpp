...
#include "../SurLesPasDeMontfortAndroid/gps.h"
...
QT_MOC_LITERAL(1, 4, 16), // "nouvellePosition"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 16), // "QGeoPositionInfo"
QT_MOC_LITERAL(4, 39, 8), // "position"
QT_MOC_LITERAL(5, 48, 15) // "positionUpdated"

    },
    "GPS\0nouvellePosition\0\0QGeoPositionInfo\0"
    "position\0positionUpdated"
};
...
void GPS::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->nouvellePosition((*reinterpret_cast< QGeoPositionInfo(*)>(_a[1]))); break;
        ...
        {
            typedef void (GPS::*_t)(QGeoPositionInfo );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GPS::nouvellePosition)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void GPS::nouvellePosition(QGeoPositionInfo _t1)
{
